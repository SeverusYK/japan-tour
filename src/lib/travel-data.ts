...
export const reservationData: ReservationItem[] = [
  ...
  },
  {
    ...
    nameKo: "시부야 스카이 전망대",
    nameEn: "SHIBUYA SKY",
    subtitleKo: "오전 10시 입장 티켓 (사전 예약 필요)",
...
export const checklistData: ChecklistCategory[] = [
  ...
  },
  {
    ...
    key: "booking",
    items: [
      { labelKo: "시부야 스카이 입장권 예약 (사전 필수)", labelEn: "SHIBUYA SKY Ticket", key: "bk-shibuya-sky" },
      { labelKo: "우시고로 신주쿠 와규 예약 (사전 필수)", labelEn: "USHIGORO Reservation", key: "bk-ushigoro" },
      { labelKo: "도쿄 시티뷰 전망대 티켓 확인", labelEn: "TOKYO CITY VIEW Ticket", key: "bk-tcv" },
